...
#python logplot.py -d ../bench  -b messaging -min 10 -max 100 -step 10 -l 5
    ...
    SpalshBenchPlotRun("../bench", "20", True, 2, 1, 1, title = "Fig-1 spalsh runtime", ylabel = "time", minY = 0, maxY = 7)
    SpalshBenchPlotRun("../bench", "power", True, 2, 1, 2, title = "Fig-2 splash power", ylabel = "power", minY = 0, maxY = 3.5)
